...
Users can navigate between the main dashboard and trend analysis pages.
...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("ℹ️ About"):
            ...
            **Navigation:**
            - Main Dashboard: Interactive map and overview
            - Trend Analysis: Time-based analysis and trend charts
            """
            )
